...
<body>
	...
	<div class="section">
		<div class="container">
			<h3 style="font-family: Arial, Helvetica, sans-serif; margin-left: 15px">Profil</h3>
			<div class="box">
			...
			<h3 style="font-family: Arial, Helvetica, sans-serif; margin-left: 15px">Ubah Password</h3>
			<div class="box">
				<form action="" method="POST">
