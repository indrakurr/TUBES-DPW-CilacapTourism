...
<body>
	...
	<div class="section">
		<div class="container">
			<h3 style="font-family: Arial, Helvetica, sans-serif; margin-left: 30px">Detail Tempat Wisata</h3>
				<div class="col-lg-12">
                    <div class="box" style="border-radius: 20px; border: none">
					    ...
					    <h3 style="font-family: Arial, Helvetica, sans-serif"><strong><br> Deskripsi :<br></strong></h3>
